...
export const craneRatgeber: Record<string, CraneRatgeber> = {
  ...
  'minikran-mieten': {
    ...
    sizeClasses: [
      ...
      {
        label: 'Großer Spinnenkran 8–10t',
        tonnage: '8–10t',
        reach: '25–32m',
        useCase: 'Anspruchsvolle Indoor-Großprojekte, Brückenelemente in beengten Innenstadtbaustellen, Solaranlagen auf Industriedächern',
        priceRange: '750–1.200€/Tag',
      },
    ],
  },
