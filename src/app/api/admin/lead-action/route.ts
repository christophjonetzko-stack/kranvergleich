...
import { markLeadWon, markLeadLost, sendNachfassen, sendCustomerMail } from '@/lib/lead-actions'
...
export async function POST(req: Request) {
  ...
  else res = await sendCustomerMail(body.leadId, body.subject, body.body)
