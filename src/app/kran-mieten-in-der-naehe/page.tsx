...
const naeheFAQs = [
  ...
  },
  {
    ...
    answer:
      'Das hängt von Last und Zufahrt ab — nicht von der Region. Für enge Innenstädte und Innenhöfe: Minikran. Für Dacharbeiten am Einfamilienhaus: Dachdeckerkran. Für Dachstuhlmontage oder Pool/Whirlpool: Autokran 30–50t. Für Industrie- und Hochbau: Mobilkran. Für Großbaustellen über mehrere Monate: Baukran (Turmdrehkran). Unser Kostenrechner führt Sie in 60 Sekunden zum passenden Typ — inkl. Preisspanne.',
  },
]
...
export default async function KranMietenInDerNaehePage() {
  ...
  // Counts are stale ≥5 vs Supabase (cosmetic only — we sort, don't display the number).
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Trust stats — quick credibility row */}
      <section className="mb-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div className="bg-gray-50 rounded-lg p-4 text-center">
            ...
            <p className="text-[11px] text-gray-400">kostenlos &amp; unverbindlich</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">
          So finden Sie den passenden Kran in Ihrer Nähe — in 3 Schritten
        </h2>
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="border border-gray-200 rounded-lg p-5">
            ...
            <p className="text-[13px] text-gray-500">
              ...
              erhalten Sie konkrete Angebote inkl. Anfahrt und Kranführer.
            </p>
          </div>
        </div>
      </section>

      {/* City grid — top 30 by company count */}
      ...
      {/* SEO intro paragraph — synonym + intent coverage */}
      ...
      {/* Cross-links — keyword-rich anchors */}
      <section className="mb-10">
