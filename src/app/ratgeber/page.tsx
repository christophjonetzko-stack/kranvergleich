...
const articles = [
  ...
  },
  {
    ...
    description: 'Die zwei beliebtesten Krantypen im direkten Vergleich: Tragkraft, Kosten, Führerscheinpflicht, Einsatzbereiche. Mit Entscheidungs-Checkliste.',
  },
  {
    slug: 'kran-mieten-ohne-fuehrerschein',
    title: 'Kran mieten ohne Führerschein — was ist erlaubt?',
    description: 'Welche Krane darf man selbst bedienen, wo ist ein Kranführer Pflicht? Übersichtstabelle aller 8 Krantypen mit rechtlicher Grundlage (DGUV Vorschrift 52).',
  },
  {
    slug: 'kran-mieten-tipps',
    title: 'Kran mieten: 7 Tipps für Bauunternehmer',
    description: 'So sparen Sie bei der Kranmiete Geld und Zeit. Vom richtigen Krantyp über Genehmigungen bis zur Einsatzplanung — praktische Tipps aus der Baupraxis.',
  },
]
