      ...
      <section className="mb-10 border border-gray-200 rounded-lg p-5">
        ...
        <article className="mb-7">
          ...
          <div className="text-[14px] text-gray-600 leading-relaxed space-y-2.5">
            ...
            <p><strong className="text-gray-800">Was es kostet (Richtwert, Stand Mai 2026).</strong> Der reine Tagessatz für 30-40 t Autokran inkl. Bediener liegt bei typischen SME-Anbietern aus unserem Katalog zwischen 500 und 900 € netto. Dazu kommt die Anfahrt mit 150-500 € Pauschale oder 1-3 €/km, je nach Anbieter-Modell. Für eine Berliner Adresse mit Anbieter im Stadtgebiet ergibt das 700-1.400 € netto Gesamt. Richtwerte, keine Festpreise.</p>
        ...
        <article className="mb-7">
          ...
          <div className="text-[14px] text-gray-600 leading-relaxed space-y-2.5">
            ...
            <p><strong className="text-gray-800">Was es kostet (Richtwert, Stand Mai 2026).</strong> Ein 45-60 t Mobilkran für 4-5 Tage inkl. Bediener kostet bei typischen SME-Anbietern aus unserem Katalog 4.800-9.500 € netto. Der Tagessatz dieser Klasse liegt bei 1.200-2.000 € netto; bei mehrtägigen Einsätzen rechnen viele Anbieter mit Wochenpauschalen, die 15-25 % gegenüber Einzeltagen sparen. Innerhalb der Gesamtspanne entscheiden Anfahrt, regionale Preise und ob An- und Abfahrt am gleichen Tag erfolgen oder ob der Kran über Nacht vor Ort bleibt. Bei mehrtägigen Hausaufstellungen wird der Kran meist stationiert, das spart Hin- und Rückfahrkosten.</p>
        ...
        <article>
          ...
          <div className="text-[14px] text-gray-600 leading-relaxed space-y-2.5">
            ...
            <p><strong className="text-gray-800">Was es kostet (Richtwert, Stand Mai 2026).</strong> Ein Ladekran-Einsatz mit Pritsche für 80 km Transport plus 2-3 Stunden vor Ort kostet bei typischen SME-Anbietern aus unserem Katalog 650-1.100 € netto. Die typische Kalkulation: Tagespauschale 500-800 € inkl. LKW und Fahrer plus Anfahrt-/Abfahrt-Pauschale 150-300 €. Längere Strecken oder komplexe Anlieferungen (Tor zu schmal, Auslage über mehrere Hecken) erhöhen den Preis.</p>
