...
import { TrackProfileView, TrackedLink, TrackedWebsiteLink, RevealablePhone } from '@/components/track'
...
export default async function CompanyPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <TrackProfileView firmId={company.id} />
      {/* Breadcrumb */}
