...
// Blue pin marker as inline SVG, no external images, no CSP issues
const pinSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="25" height="41" viewBox="0 0 25 41"><path d="M12.5 0C5.6 0 0 5.6 0 12.5c0 2.4.7 4.6 1.9 6.5L12.5 41l10.6-22c1.2-1.9 1.9-4.1 1.9-6.5C25 5.6 19.4 0 12.5 0z" fill="#2563eb"/><circle cx="12.5" cy="12.5" r="5.5" fill="#fff"/></svg>`
      ...
      const marker = L.marker([c.lat, c.lng], { icon })
        .bindPopup(
          `<div style="font-family:system-ui;font-size:13px;line-height:1.4;">` +
            ...
            `<br/><a href="/anbieter/${c.slug}" style="color:#2563eb;text-decoration:none;">Profil ansehen </a>` +
          `</div>`,
          { maxWidth: 220 }
        )
